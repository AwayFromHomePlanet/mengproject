...
==>-diamond ([3] {α} c0c1) ([3] c0c2) 
  with ==>-diamond' c0c1 c0c2
...  | ⟨ c3 , ⟨ c1c3 , c2c3 ⟩ ⟩ 
  = ⟨ μ α ⇒ c3 , ⟨ [3] c1c3 , [3] c2c3 ⟩ ⟩

==>-diamond ([4] m0m1 n0n1) ([4] m0m2 n0n2) 
  with ==>-diamond m0m1 m0m2
...  | ⟨ m3 , ⟨ m1m3 , m2m3 ⟩ ⟩ 
...
==>-diamond ([4] m0m1 n0n1) ([8] {α} γ∉αc2n2 m0μc2 n0n2) 
  with ==>-diamond m0m1 m0μc2 
...  | ⟨ μ α ⇒ c3 , ⟨ m1μc3 , [3] c2c3 ⟩ ⟩ 
    with ==>-diamond n0n1 n0n2
...    | ⟨ n3 , ⟨ n1n3 , n2n3 ⟩ ⟩ 
      with fresh ((μ α ⇒ c3) · n3)
...      | ⟨ δ , δ∉αc3n3 ⟩ 
  = ⟨ μ δ ⇒ c3 [ n3 ∙ δ / α ]r' , ⟨ [8] δ∉αc3n3 m1μc3 n1n3 , μr-subst-lemma c2c3 n2n3 γ∉αc2n2 δ∉αc3n3 ⟩ ⟩

==>-diamond ([4] m0m1 n0n1) ([9] {α} γ∉v2αc2 val m0v2 n0μc2) 
  with ==>-diamond m0m1 m0v2
...  | ⟨ v3 , ⟨ m1v3 , v2v3 ⟩ ⟩ 
    with ==>-diamond n0n1 n0μc2
...    | ⟨ μ α ⇒ c3 , ⟨ n1μc3 , [3] c2c3 ⟩ ⟩ 
      with fresh (v3 · (μ α ⇒ c3))
...      | ⟨ δ , δ∉v3αc3 ⟩ 
...
==>-diamond ([7] v_ m0λm1 n0v1) ([7] _ m0λm2 n0v2) 
...
==>-diamond ([7] _ m0λm1 _) ([8] _ m0μc2 _) 
  with ==>-diamond m0λm1 m0μc2
...  | ⟨ .(ƛ _ ⇒ _) , ⟨ [2] _ , () ⟩ ⟩

==>-diamond ([7] val _ n0v1) ([9] _ _ _ n0μc2) 
...
==>-diamond ([8] {α} γ∉αc1n1 m0μc1 n0n1) ([8] δ∉αc2n2 m0μc2 n0n2) 
  with ==>-diamond m0μc1 m0μc2
...  | ⟨ μ α ⇒ c3 , ⟨ [3] c1c3 , [3] c2c3 ⟩ ⟩ 
    with ==>-diamond n0n1 n0n2
...    | ⟨ n3 , ⟨ n1n3 , n2n3 ⟩ ⟩ 
      with fresh ((μ α ⇒ c3) · n3)
...
==>-diamond ([8] _ m0μc1 _) ([9] _ val2 m0v2 _) 
...
==>-diamond ([9] {α} γ∉v1αc1 val1 m0v1 n0μc1) ([9] δ∉v2αc2 val2 m0v2 n0μc2) 
  with ==>-diamond m0v1 m0v2
...  | ⟨ v3 , ⟨ v1v3 , v2v3 ⟩ ⟩ 
    with ==>-diamond n0μc1 n0μc2
...    | ⟨ μ α ⇒ c3 , ⟨ [3] c1c3 , [3] c2c3 ⟩ ⟩ 
      with fresh (v3 · (μ α ⇒ c3))
...      | ⟨ ε , ε∉v3αc3 ⟩ 
