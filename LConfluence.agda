...
postulate 
  ...
  μl-subst-lemma : ∀ {α γ δ : Name} {M N P Q : Term} 
    ...
    → δ ∉ Q · (μ α ⇒ N) 
    ----------------
    → μ γ ⇒ M [ P ∙ γ / α ]l ==> μ δ ⇒ N [ Q ∙ δ / α ]l

  δ-subst-lemma : ∀ {α : Name} {M N P Q : Term} 
    → M ==> N 
    → P ==> Q 
    ----------------
    → M [ P / α ]δ ==> N [ Q / α ]δ
...
...      | ⟨ δ , δ∉αm3n3 ⟩ 
  = ⟨ μ δ ⇒ m3 [ n3 ∙ δ / α ]r , ⟨ [11] δ∉αm3n3 m1μm3 n1n3 , μr-subst-lemma m2m3 n2n3 γ∉αm2n2 δ∉αm3n3 ⟩ ⟩
...
...      | ⟨ δ , δ∉v3αn3 ⟩ 
  = ⟨ μ δ ⇒ n3 [ v3 ∙ δ / α ]l , ⟨ [12] δ∉v3αn3 (val-red-val v2v3 val) m1v3 n1μn3 , μl-subst-lemma n2n3 v2v3 γ∉v2αn2 δ∉v3αn3 ⟩ ⟩
...
==>-diamond ([6] m0m1 n0n1) ([10] {x} m0νm2 n0n2)
  with ==>-diamond m0m1 m0νm2 
...  | ⟨ ν x ⇒ m3 , ⟨ m1νm3 , [3] m2m3 ⟩ ⟩ 
    with ==>-diamond n0n1 n0n2
...    | ⟨ n3 , ⟨ n1n3 , n2n3 ⟩ ⟩ 
  = ⟨ m3 [ n3 / x ]β , ⟨ [10] m1νm3 n1n3 , β-subst-lemma m2m3 n2n3 ⟩ ⟩
...
...  | ⟨ μ α ⇒ m3 , ⟨ m1μm3 , [4] m2m3 ⟩ ⟩ 
    with ==>-diamond n0n1 n0n2
...    | ⟨ n3 , ⟨ n1n3 , n2n3 ⟩ ⟩ 
  = ⟨ m3 [ n3 / α ]δ , ⟨ [13] m1μm3 n1n3 , δ-subst-lemma m2m3 n2n3 ⟩ ⟩
...
==>-diamond ([9] _ m0λm1 _) ([11] _ m0μc2 _) 
  with ==>-diamond m0λm1 m0μc2
...  | ⟨ .(ƛ _ ⇒ _) , ⟨ [2] _ , () ⟩ ⟩

==>-diamond ([9] val _ n0v1) ([12] _ _ _ n0μc2) 
  with ==>-diamond n0v1 n0μc2 
...  | ⟨ .(μ _ ⇒ _) , ⟨ v1μc3 , [4] _ ⟩ ⟩ 
    with val-red-val v1μc3 val
...    | ()


==>-diamond p0p1@([10] _ _) p0p2@([6] _ _) = reverse p0p1 p0p2

==>-diamond ([10] {x} m0νm1 n0n1) ([10] m0νm2 n0n2) 
  with ==>-diamond m0νm1 m0νm2
...  | ⟨ ν x ⇒ m3 , ⟨ [3] m1m3 , [3] m2m3 ⟩ ⟩
    with ==>-diamond n0n1 n0n2
...    | ⟨ n3 , ⟨ n1n3 , n2n3 ⟩ ⟩
  = ⟨ m3 [ n3 / x ]β , ⟨ β-subst-lemma m1m3 n1n3 , β-subst-lemma m2m3 n2n3 ⟩ ⟩

==>-diamond ([10] m0νm1 _) ([13] m0μm2 _)
...
...    | ⟨ n3 , ⟨ n1n3 , n2n3 ⟩ ⟩ 
      with fresh ((μ α ⇒ m3) · n3)
...      | ⟨ ε , ε∉αm3n3 ⟩ 
  = ⟨ μ ε ⇒ m3 [ n3 ∙ ε / α ]r , ⟨ μr-subst-lemma m1m3 n1n3 γ∉αm1n1 ε∉αm3n3 , μr-subst-lemma m2m3 n2n3 δ∉αm2n2 ε∉αm3n3 ⟩ ⟩

==>-diamond ([11] _ m0μc1 _) ([12] _ val2 m0v2 _) 
  with ==>-diamond m0μc1 m0v2
...  | ⟨ .(μ _ ⇒ _) , ⟨ [4] _ , v2v3 ⟩ ⟩ 
...
...    | ⟨ μ α ⇒ n3 , ⟨ [4] n1n3 , [4] n2n3 ⟩ ⟩ 
      with fresh (v3 · (μ α ⇒ n3))
...      | ⟨ ε , ε∉v3αn3 ⟩ 
  = ⟨ μ ε ⇒ n3 [ v3 ∙ ε / α ]l , ⟨ μl-subst-lemma n1n3 v1v3 γ∉v1αn1 ε∉v3αn3 , μl-subst-lemma n2n3 v2v3 δ∉v2αn2 ε∉v3αn3 ⟩ ⟩


==>-diamond p0p1@([13] _ _) p0p2@([6] _ _) = reverse p0p1 p0p2

==>-diamond p0p1@([13] _ _) p0p2@([10] _ _) = reverse p0p1 p0p2
...
... | ⟨ μ α ⇒ m3 , ⟨ [4] m1m3 , [4] m2m3 ⟩ ⟩
    with ==>-diamond n0n1 n0n2
...    | ⟨ n3 , ⟨ n1n3 , n2n3 ⟩ ⟩
  = ⟨ m3 [ n3 / α ]δ , ⟨ δ-subst-lemma m1m3 n1n3 , δ-subst-lemma m2m3 n2n3 ⟩ ⟩
